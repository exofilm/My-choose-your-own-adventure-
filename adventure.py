...
choice1 = input('You are nearing the edge of the forest, would you like to go left or right?')
if choice1 == "left":
    print('You are safe.... for now.')
    choice2 = input("You find yourself overlooking a rapid river. Would you like to 'swim' through it, or 'wait' for a boat?")
    if choice2 == 'wait':
        print('A boat arrives and takes you safely across the river')
        choice3 = input('You made it across the river. Congrats nerd! On the other side of the river, you find three doors. One is red, one is blue, and one is yellow. Which door would you like to go through?' )
        if choice3 == "red":
